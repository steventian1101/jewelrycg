@extends('backend.dashboard.layouts.app', ['activePage' => 'posts', 'title' => 'All Users', 'navName' => 'Table List', 'activeButton' => 'laravel'])
                            ...
                            <tbody>
                                @foreach ($tags as $tag)
                                    <tr>
                                        ...
                                        <td> {{ $tag->slug }} </td>
                                        <td>
                                            <a href="{{ route('backend.blog.tags.edit', $tag->id) }}" class="btn btn-white btn-sm">
