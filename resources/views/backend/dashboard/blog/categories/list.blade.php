@extends('backend.dashboard.layouts.app', ['activePage' => 'posts', 'title' => 'Blog Categories', 'navName' => 'blogcategories', 'activeButton' => 'blog'])
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a class="btn btn-white btn-sm" href="{{ route('backend.blog.categories.edit', $categorie->id) }}"> <i class="bi-eye"></i> Edit </a>
                                            <!-- Button Group -->
                                            <div class="btn-group">
