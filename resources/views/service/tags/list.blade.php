            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('seller.service.tags.store') }}" method="POST">
                                @csrf
                                @if ($errors->has('name'))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a class="btn btn-dark btn-sm" href="{{ route('seller.service.tags.edit', $tag->id) }}">Edit</a>
                                                        <!-- Button Group -->
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="ordersExportDropdown1" style="">
                                                                ...
                                                                <a class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this product?')" href="{{ route("seller.service.tags.delete", $tag->id) }}">Delete</a>
                                                            </div>
                                                        </div>
                                                        <!-- End Unfold -->
                                                    </div>
