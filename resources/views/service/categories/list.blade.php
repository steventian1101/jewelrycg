            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Service Categories</h1>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{ route('seller.service.categories.create') }}">Create category</a>
                    </div>
                    <!-- End Col -->
                </div>
                <!-- End Row -->
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a class="btn btn-dark btn-sm" href="{{ route('seller.service.categories.edit', $categorie->id) }}">Edit</a>
                                            @if ($nIndex != 1)
                                                <!-- Button Group -->
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="ordersExportDropdown1" style="">
                                                        ...
                                                        <a class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this product?')" href="{{ route('seller.service.categories.delete', $categorie->id) }}">Delete</a>
                                                    </div>
                                                </div>
                                                <!-- End Unfold -->
                                            @endif
                ...
                <script>
                    $(function() {
                        ...
                        $('.table').DataTable({
                            ...
                            serverSide: true,
                            bAutoWidth: false,
                            ajax: "{{ route('seller.service.categories.get') }}",
                            columns: [{
                                    data: 'id',
                                    name: 'id'
                                },
