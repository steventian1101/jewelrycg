    ...
    <div class="col-md-12">
        <div class="card strpied-tabled-with-hover rounded-0">
            <div class="table-full-width">
                <div class="col-md-12">
                    <table id="product_diamonds_list" class="table table-lg table-thead-bordered table-nowrap table-align-middle card-table dataTable table-responsive no-footer">
                        <thead>
                            <th>Type</th>
                            <th>Size</th>
                            <th>Amount</th>
