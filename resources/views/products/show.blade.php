                        ...
                        <div class="col-xl-6 col-lg-6"> 
                            <div class="bg-white p-3 mb-0">
                                ...
                                <form action="{{route('cart.store')}}" method="post" class="my-3">
                                    @csrf
                                    <input type="hidden" name="id_product" value="{{$product->id}}">
                                    <button type="submit" class="btn btn-primary" {{ $product->qty < 1 ? 'disabled' : null }}>Add to Cart</button>
                                    <button type="submit" formaction="{{route('cart.buy.now')}}" class="btn btn-warning" {{ $product->qty < 1 ? 'disabled' : null }}>Buy Now</button>
                                </form>        
