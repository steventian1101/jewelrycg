            ...
            <div class="order-items-card border-bottom py-4 mb-4">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6 mb-2">
                        ...
                        <div class="fs-14 ">{{ ucwords(Config::get('constants.oder_payment_status')[$order->status_payment]) }}</div>
                    </div>
                    <div class="col-lg-3 col-6 mb-2">
                        ...
                        <div class="fs-14 ">
                            @php
                                ...
                                foreach ($order->items as $key => $item) {
                                    if ($item->fulfilment_status != '3') $status = 'Pending';
                                }
                        ...
                        <div class="col-lg-10 col-9">
                            ...
                            @if ($item->product->is_digital)
                                ...
                                @if ($item->product_variant)
                                    <a href="javascript:;" class="variant_download" data-variant-id="{{ $item->product_variant }}">
